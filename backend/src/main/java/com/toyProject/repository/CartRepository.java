...
public interface CartRepository extends JpaRepository<Cart, Long> {
    ...
    @Query("SELECT DISTINCT ci.cart.user.userId FROM CartItem ci " +
            "WHERE ci.product IN :products")
    List<Long> findUserIdsByProducts(@Param("products") List<Product> products);
